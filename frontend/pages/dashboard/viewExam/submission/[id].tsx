...
import { SubmissionDetail } from "../[id]";
                ...
                (
                    <div className="bg-white shadow overflow-hidden sm:rounded-lg">
                        <div className="flex justify-between items-center text-sm">
                            ...
                            <div className="px-4 py-5 sm:px-6">
                                <button
                                    onClick={() => router.back()} className="shrink inline-flex justify-center py-2 px-4 border border-transparent shadow-sm text-sm font-medium rounded-md text-white bg-indigo-600 hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500"
                                >
                                    Go Back
                                </button>
                                    ...
                                    <div className="bg-white border-b px-4 py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
                                        ...
                                        <div className="col-span-2 grid grid-cols-2 gap-3">
                                            {evidences?.map((evidence: any) => (
                                                <div key={evidence} className="rounded overflow-hidden shadow-lg">
