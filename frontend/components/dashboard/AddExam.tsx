          ...
          <div className="px-4 py-5 bg-white sm:p-6">
            <div className="grid grid-cols-6 gap-6">
              ...
              <div  className="col-span-6 ">
                ...
                <div className="mt-1">
                  <textarea id="about" name="about" className="height shadow-sm focus:ring-indigo-500 focus:border-indigo-500 mt-1 block w-full sm:text-sm border-gray-300 rounded-md" placeholder="you@example.com"></textarea>
                </div>
              </div>
